...
struct UserPayload: Content, Validatable {
    ...
    init(id: UUID?, name: String, lastName: String, userName: String, email: String, password: String?, confirmPassword: String?, userRole: String, dateOfBirth: String, createdAt: Date? = nil, updatedAt: Date? = nil) {
        self.name = name
